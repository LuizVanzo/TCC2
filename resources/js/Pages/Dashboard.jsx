                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    {memorial.length > 0 ? (
                        ...
                        <div className="flex justify-center items-center p-6">
                            <div className="bg-white shadow-md rounded-lg p-4 text-center text-gray-500 max-w-sm">
                                <p>Nenhum memorial no momento.</p>
                            </div>
                        </div>
                    )}
                    ...
                    {familia.length > 0 ? (
                        ...
                        <div className="flex justify-center items-center p-6">
                            <div className="bg-white shadow-md rounded-lg p-4 text-center text-gray-500 max-w-sm">
                                <p>Nenhuma família cadastrada no momento.</p>
                            </div>
                        </div>
                    )}
                    {/*
                    <h1 className="text-2xl font-bold mt-5">Exemplo de Memorial</h1>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-5">
